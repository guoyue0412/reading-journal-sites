...
export default async function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (!entry) notFound();
  return <ResearchShell><MarkdownArticle entry={entry} relatedEntries={getRelatedEntries(entry.slug, entries)} reflectionNavigation={getReflectionNavigation(entry.slug, entries)} /></ResearchShell>;
}
